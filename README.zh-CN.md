...
v0.2 起 StateProbe 采用 **hybrid evidence 架构**（[ADR_009](docs/ADR_009_hybrid_engine.md)）：多个证据贡献者并行观察 prompt，各自发出带 confidence 的证据，统一聚合到 8 个轴的读数。
...
完整计划：[project plan](docs/PROJECT_PLAN.md)、[open-source plan](docs/OPEN_SOURCE_PLAN.md)、[CHANGELOG](CHANGELOG.md)。
...
- [Quality bar](docs/QUALITY_BAR.md) — 10k-star reference 标准
...
- [Open-source plan](docs/OPEN_SOURCE_PLAN.md) — 完整开源项目计划
- [Project plan](docs/PROJECT_PLAN.md) — 项目北极星与版本路线
